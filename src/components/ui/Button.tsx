...
const base =
  'inline-flex items-center justify-center gap-2 rounded-full font-semibold text-base leading-none transition-colors duration-150 min-h-[48px] px-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-practice-focus disabled:opacity-50 disabled:pointer-events-none motion-reduce:transition-none';
